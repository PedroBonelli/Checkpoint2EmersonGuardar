        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="well">
					...
					<form:form modelAttribute="AlbumModel" action="${contextPath}/albums/${AlbumModel.id}" method="put">
						...
						<hr>
							...
							<div class="form-group">
							<label class="control-label" for="nome">Ano de Lancamento:</label>
